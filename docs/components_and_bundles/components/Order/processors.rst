...
Order processors are responsible for manipulating the orders in order to apply different predefined adjustments or other modifications based on order state.
